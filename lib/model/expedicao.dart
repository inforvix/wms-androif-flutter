...
class Expedicao {
  ...
  Expedicao copyWith(
    ...
    return Expedicao(
        ...
        exp_quantidade_separada:
            exp_quantidade_separada ?? this.exp_quantidade_separada,
  ...
  factory Expedicao.fromMap(Map<String, dynamic> map) {
    String exp_pedido;
    String pro_codigo;
    String exp_endereco;
    String exp_caixa;
  ...
  factory Expedicao.Db(Map<String, dynamic> map) {
    String exp_pedido;
    String pro_codigo;
    String exp_endereco;
    String exp_caixa;
    ...
    try {
      exp_quantidade_conferida = map['EXP_QUANTIDADE_CONFERIDA'] + 0.0;
    } catch (e) {
  ...
  factory Expedicao.fromJson(String source) =>
      Expedicao.fromMap(json.decode(source) as Map<String, dynamic>);
